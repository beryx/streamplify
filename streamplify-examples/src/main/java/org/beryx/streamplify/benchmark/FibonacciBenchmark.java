...
/**
 * Performs parallel and sequential benchmarks on the {@link org.beryx.streamplify.example.Fibonacci} class.
 * <br>On multicore and multiprocessor systems, the parallel version is typically faster than the sequential one.
 * <br>(However, if you replace {@link org.beryx.streamplify.example.Fibonacci.Supplier#forIndex(int)}
 * with {@link org.beryx.streamplify.example.Fibonacci.Supplier#forIndexBinet(int)}}, the parallel version is typically slower.)
 */
